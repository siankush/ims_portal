...
<div class="row">
    ...
    <div class="column-responsive column-80">
        ...
        <h1 style="padding-bottom:70px; text-align:center;font-weight:800;font-size:35px;color:white">INSURANCE POLICY EDIT</h1>

            <?= $this->Form->create($insurancePolicy) ?>
            <fieldset>
                <?php
                    echo $this->Form->control('insurance_company_id', ['options' => $insuranceCompanies,'class'=>'policy']);
                    echo $this->Form->control('name',['class'=>'policy']);
                    echo $this->Form->control('premium',['class'=>'policy']);
                ?>
            </fieldset>
