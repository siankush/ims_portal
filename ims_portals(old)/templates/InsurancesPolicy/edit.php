...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $insurancesPolicy->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $insurancesPolicy->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="insurancesPolicy form content">
            ...
            <fieldset>
                <legend><?= __('Edit Insurances Policy') ?></legend>
                <?php
